...
function Get-HookSettings
{
    ...
    $Rest_Url = "{0}/{1}/{2}/hooks/{3}/config" -f $Server,$GithubProject,$GithubRepo,$HookKey
    #$Rest_Url = "https://api.github.com/repos/$GithubProject/$GithubRepo/hooks/$HookKey/config"
